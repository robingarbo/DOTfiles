...
;;;***

;;;### (autoloads nil "cedet-compat" "cedet-compat.el" (19372 55953))
...
(if (not (fboundp (quote called-interactively-p))) (defsubst called-interactively-p (&optional arg) "Compat function.  Calls `interactive-p'" (interactive-p)) (condition-case nil (called-interactively-p nil) (error (defvar cedet-compat-called-interactively-p (let ((tmp (symbol-function (quote called-interactively-p)))) (if (subrp tmp) tmp (or cedet-compat-clled-interactively-p tmp))) "Built-in called interactively function.") (defun cedet-called-interactively-p (&optional arg) "Revised from the built-in version to accept an optional arg." (case arg (interactive (interactive-p)) ((any nil) (funcall cedet-compat-called-interactively-p)))) (fset (quote called-interactively-p) (quote cedet-called-interactively-p)))))

;;;***

;;;### (autoloads (cedet-cscope-version-check cedet-cscope-expand-filename
;;;;;;  cedet-cscope-search cedet-cscope-command) "cedet-cscope"
;;;;;;  "cedet-cscope.el" (19373 12947))
...
;;;;;;  "cedet-m3" "cedet-m3.el" (19370 15857))
